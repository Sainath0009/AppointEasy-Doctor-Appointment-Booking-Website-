  ...
  return (
    ...
    <div className="mx-auto max-w-screen-2xl px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
      ...
      <div className="mt-8 grid grid-cols-1 gap-4 md:grid-cols-3 ">
        <blockquote className="flex h-full flex-col justify-between bg-white p-6 shadow-sm sm:p-8  hover:border-primary hover:shadow-2xl transition-all ease-in-out">
          <div>
