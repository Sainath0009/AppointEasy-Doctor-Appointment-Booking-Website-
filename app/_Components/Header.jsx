      ...
      {user ?
        ...
        <Popover>
          ...
          <PopoverContent className="w-200 h-300  ">
            ...
            hover:bg-slate-100 p-2 rounded-md flex items-center gap-2 justify-center' >My Booking  <Image
            src='./calendar-check-2.svg'
            width={20}
            height={20}
            alt='logout-icon'
          /></Link>
            ...
            hover:bg-slate-100 p-2 rounded-md'>
                <LogoutLink className='flex items-center gap-2 justify-center'>
                  Logout
                  <Image
                    src='./log-out.svg'
                    width={20}
