      ...
      <div className="mx-auto max-w-screen-xl px-4 pb-6 pt-16 sm:px-6 lg:px-8 lg:pt-24">
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          <div>
            ...
            The health industry drives advancements in medical care, offering innovative services and technologies to enhance patient outcomes and streamline healthcare access online.  </p>
            ...
            <div className="text-center sm:text-left">
              ...
              <ul className="mt-8 space-y-4 text-sm">
                ...
                >
                  ...
                  AGPIT ,Vijapur Road, Pratap Nagar, Solapur, Maharashtra
                  </address>
                </li>
              </ul>
            </div>
        ...
        <div className="mt-12 border-t border-gray-100 pt-6">
          <div className="text-center sm:flex sm:justify-between sm:text-left">
            ...
            <p className="mt-4 text-sm text-gray-500 sm:order-first sm:mt-0">&copy; 2024 AppointEasy</p>
          </div>
        </div>
      </div>
    </footer >
