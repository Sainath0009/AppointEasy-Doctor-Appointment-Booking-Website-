...
function About() {
        ...
        <div className="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8 lg:py-16">
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-16">
            ...
            <div className="lg:py-24">
              <h2 className="text-3xl font-semibold  text-gray-800 capitalize lg:text-3xl dark:text-white sm:text-4xl">About  <span className='text-primary'> AppointEasy </span> </h2>
  ...
  <div className="mx-auto max-w-screen-xl px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
    <h2 className=" text-2xl font-semibold text-center tracking-tight text-gray-900 sm:text-5xl">
