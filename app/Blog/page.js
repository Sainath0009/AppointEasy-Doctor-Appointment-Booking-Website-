    ...
    <div className="blog">
      ...
      <div className="block md:flex md:space-x-2 px-2 lg:p-0">
        ...
        >
          ...
          <img src="https://images.unsplash.com/photo-1493770348161-369560ae357d?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=2100&q=80" className="absolute left-0 top-0 w-full h-full rounded z-0 object-cover" alt="Nutrition" />
          <div className="p-4 absolute bottom-0 left-0 z-20">
            ...
            <div className="flex mt-3">
              <img src="https://randomuser.me/api/portraits/men/97.jpg"
                className="h-10 w-10 rounded-full mr-2 object-cover" alt="Mike Sullivan" />
              <div>
        ...
        >
          <div className="absolute left-0 top-0 w-full h-full z-10"
            style={{ backgroundImage: 'linear-gradient(180deg,transparent,rgba(0,0,0,.7))' }}></div>
          <img src="https://images.unsplash.com/photo-1543362906-acfc16c67564?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1301&q=80" className="absolute left-0 top-0 w-full h-full rounded z-0 object-cover" alt="Science" />
          <div className="p-4 absolute bottom-0 left-0 z-20">
            ...
            <div className="flex mt-3">
              <img
                ...
                className="h-10 w-10 rounded-full mr-2 object-cover" alt="Chrishell Staus" />
              <div>
      ...
      <div className="block lg:flex lg:space-x-2 px-2 lg:p-0 mt-10 mb-10">
        ...
        <div className="w-full lg:w-2/3">
            ...
            <div className="bg-white rounded px-4 flex flex-col justify-between leading-normal">
              ...
              <div className="flex mt-3">
                <img src="https://randomuser.me/api/portraits/men/86.jpg"
                  className="h-10 w-10 rounded-full mr-2 object-cover" alt="eduard franz" />
                <div>
          ...
          {/* Add JSX for other post cards here */}
